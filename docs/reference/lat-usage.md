# lat.md usage reference

Reference material extracted from AGENTS.md. Repository workflow requirements live in AGENTS.md; authoring rules live in `.agents/skills/lat-md/SKILL.md`.
