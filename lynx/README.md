...
The macOS host adapter also translates AppKit wheel deltas into Clay's scroll
coordinate convention, while preserving the user's natural-scrolling setting.
