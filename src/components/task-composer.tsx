  ...
  return (
    <>
      <form onSubmit={submitTask} aria-disabled={disabled}>
        <InputGroup
          className={`min-h-14 items-end rounded-2xl bg-card p-2 shadow-sm transition-opacity focus-within:opacity-100 has-[[data-slot=input-group-control]:focus-visible]:border-input has-[[data-slot=input-group-control]:focus-visible]:ring-0 ${disabled ? 'opacity-45' : ''}`}
        >
          {skillsOpen ? (
            <div
              id={skillsPopupId}
