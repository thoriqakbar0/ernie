...
/** Clones the dedicated mirror without touching the live installation. The caller owns cleanup. */
export async function inspectRelease(context: SourceContext, signal?: AbortSignal): Promise<Candidate | null> {
