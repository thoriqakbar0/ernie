...
export function AgentAvatar({ avatar, size = "default", working = false, animated = false }: {
  avatar: Agent["avatar"]
  ...
  const ink = "#20213c"
  const paper = "#fff9ed"
  if (typeof avatar === "object") return <span {...stylex.props(rosterStyles.avatar, size === "large" && rosterStyles.avatarLarge, size === "small" && rosterStyles.avatarSmall)} data-working={working} aria-hidden="true"><GeneratedCharacter seed={avatar.seed} animated={animated || working}/></span>
    ...
    <svg {...stylex.props(rosterStyles.avatarSvg)} viewBox="-56 -60 112 112" fill="none" stroke={ink} strokeWidth="3.5" strokeLinejoin="round" strokeLinecap="round">
      <g {...stylex.props(working ? rosterStyles.working : animated && rosterStyles.idleMotion)}>
        {avatar === "fern" ? <>
          ...
          <g {...stylex.props((working || animated) && rosterStyles.workingEyes)} fill={ink} stroke="none"><circle cx="-12" r="3.5"/><circle cx="12" r="3.5"/></g><path d="M-8 26H8"/>
        </> : avatar === "tide" ? <>
          <ellipse cy="22" rx="42" ry="23.5" fill="#b658ff"/>
          <g {...stylex.props((working || animated) && rosterStyles.workingEyes)}><ellipse cx="-19" cy="-4" rx="17" ry="26.5" fill={paper}/><ellipse cx="19" cy="-10" rx="17" ry="26.5" fill={paper}/><ellipse cx="-19" cy="-4" rx="5.5" ry="9.5" fill={ink}/><ellipse cx="19" cy="-10" rx="5.5" ry="9.5" fill={ink}/></g>
        </> : avatar === "ember" ? <>
          ...
          <g {...stylex.props((working || animated) && rosterStyles.workingEyes)} fill={ink} stroke="none"><circle cx="-13" cy="4" r="2.5"/><circle cx="11" cy="4" r="2.5"/></g><path d="M-9 10a8 6.5 0 0 0 16 0"/>
        </> : <>
          ...
          <g {...stylex.props((working || animated) && rosterStyles.workingEyes)} fill={ink} stroke="none"><ellipse cx="-11" cy="-3" rx="2.5" ry="4.5"/><ellipse cx="11" cy="-3" rx="2.5" ry="4.5"/></g><path d="M-8.5 6a8.5 6 0 0 0 17 0"/>
        </>}
      </g>
    </svg>
  </span>
