...
export const styles = stylex.create({
  ...
  ghostCopy: { textAlign: "center", color: theme["--muted"], fontSize: 13, lineHeight: 1.65, textWrap: "pretty" },
  ghostTitle: { marginBottom: 5, fontFamily: "Georgia, serif", fontSize: 19, color: theme["--ink"] },
  ghostRow: { display: "grid", placeItems: "center", alignContent: "center", gap: 18, minHeight: 220, height: "100%", padding: 24 },
  ghostAgent: { width: "min(160px, 100%)", aspectRatio: "1", opacity: 0.16, filter: "grayscale(0.65)", transform: "rotate(-8deg)", pointerEvents: "none" },
