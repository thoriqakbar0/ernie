...
export const styles = stylex.create({
  ...
  emptyAction: { display: "inline-flex", width: "fit-content", minHeight: 36, alignItems: "center", justifyContent: "center", marginTop: 4, padding: "0 13px", borderRadius: 9, color: "#fffaf5", cursor: "pointer", fontSize: 13, fontWeight: 650, backgroundColor: { default: theme["--accent"], ":hover": theme["--accent-hover"] } },
