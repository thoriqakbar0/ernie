...
import { LiveSessionChatSurface, SessionChatSurface } from "../sessions/session-chat-surface";
import { SpaceLaunchpad } from "../space-launchpad/space-launchpad";
import { WorkspaceSidebar } from "../workspace-sidebar";
import { PerformanceHud, PerformanceProfiler } from "../performance/performance-hud";
import { Icon } from "../ui/workspace-icon";
import { summarizeAgentDescendantActivity, projectForAgent, statusText } from "../../lib/workspace-agent-presentation";
import { readSpaceLaunchPreference, writeSpaceLaunchPreference, type SpaceLaunchPreference } from "../space-launchpad/space-launch-preferences";
