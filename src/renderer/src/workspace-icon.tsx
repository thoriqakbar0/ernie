...
export type IconName = "archive" | "branch-add" | "chevron" | "folder" | "close" | "folder-add" | "restore" | "search" | "sidebar-close" | "subagent-fork" | "subagent-network" | "subagent-waypoints" | "subagent-workflow" | "trash";

const ICON_PATHS: Record<IconName, ReactNode> = {
  archive: <><rect width="20" height="5" x="2" y="3" rx="1" /><path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8m-10 4h4" /></>,
  "branch-add": <><path d="M6 3v12" /><circle cx="18" cy="6" r="3" /><circle cx="6" cy="18" r="3" /><path d="M15 6a9 9 0 0 0-9 9m12 0v6m3-3h-6" /></>,
