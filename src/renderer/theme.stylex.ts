...
export const theme = stylex.defineVars({
  ...
  "--shadow-composer":
    "0 18px 48px -28px var(--ernie-light, rgb(43 26 7 / 0.28)) var(--ernie-dark, rgb(0 0 0 / 0.62)), 0 5px 16px -10px var(--ernie-light, rgb(43 26 7 / 0.14)) var(--ernie-dark, rgb(0 0 0 / 0.5))",
