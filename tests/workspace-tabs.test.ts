...
import { initialWorkspaceTabs, resolveRootTabStatus, resolveWorkspaceTabSurface, workspaceTabsReducer } from "../src/renderer/src/components/workspace/workspace-tabs";
